...
export default function ExpertServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
        ...
        <div className="relative container mx-auto px-6 py-24">
          ...
          >
            <div className="flex justify-center mb-6">
              <motion.div
                className="p-4 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-2xl border border-amber-500/30"
                animate={{
                  boxShadow: [
              ...
              >
                <HeadphonesIcon className="w-12 h-12 text-amber-400" />
              </motion.div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <motion.button
                ...
                className="px-10 py-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 text-lg"
      ...
      <section className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`h-full p-6 bg-gray-900/50 border border-gray-800 rounded-xl hover:border-gray-700 transition-all duration-300 cursor-pointer ${
                    selectedService === index ? 'ring-2 ring-amber-500/50' : ''
                  }`}
                  onClick={() => handleServiceClick(index)}
                >
                  <div
                    className={`inline-flex p-3 rounded-lg bg-gradient-to-br ${service.gradient} bg-opacity-20 mb-4`}
                  >
        ...
        >
          ...
          <motion.button
            ...
            className="px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
          ...
          {[
            ...
            >
              <div className="text-center">
                ...
                <div className="text-4xl font-bold text-amber-500/30 mb-2">{item.step}</div>
      ...
      <section id="cta-section" className="container mx-auto px-6 py-20">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {/* Main CTA Card */}
          <div className="bg-gradient-to-br from-amber-900/20 via-orange-900/20 to-amber-900/20 rounded-3xl p-12 md:p-16 border border-amber-500/30 text-center relative overflow-hidden">
            ...
            >
              ...
              {/* What you'll get */}
              <div className="bg-gray-900/50 rounded-2xl p-8 mb-10 max-w-3xl mx-auto">
                <h3 className="text-lg font-semibold text-amber-400 mb-6">In Your Free Discovery Call, We'll:</h3>
              ...
              <motion.button
                ...
                className="px-12 py-5 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold rounded-lg shadow-xl hover:shadow-2xl transition-all duration-200 text-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <div className="flex items-center gap-3">
