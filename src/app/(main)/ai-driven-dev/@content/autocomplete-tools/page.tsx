...
import AutocompleteToolsContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('autocomplete-tools')!;
...
export default function AutocompleteToolsPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <AutocompleteToolsContent />
    </>
  );
}
