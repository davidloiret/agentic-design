...
import TerminalAgentsContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('terminal-agents')!;
...
export default function TerminalAgentsPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <TerminalAgentsContent />
    </>
  );
}
