...
import APIWrapperLibraryContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('api-wrapper-library')!;
...
export default function APIWrapperLibraryPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <APIWrapperLibraryContent />
    </>
  );
}
