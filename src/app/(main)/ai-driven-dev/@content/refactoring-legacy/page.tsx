...
import RefactoringLegacyRedirect from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('refactoring-legacy')!;
...
export default function RefactoringLegacyPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <RefactoringLegacyRedirect />
    </>
  );
}
