...
import BugHuntingProductionContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('bug-hunting-production')!;
...
export default function BugHuntingProductionPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <BugHuntingProductionContent />
    </>
  );
}
