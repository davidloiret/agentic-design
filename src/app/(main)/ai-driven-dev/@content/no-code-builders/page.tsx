...
import NoCodeBuildersContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('no-code-builders')!;
...
export default function NoCodeBuildersPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <NoCodeBuildersContent />
    </>
  );
}
