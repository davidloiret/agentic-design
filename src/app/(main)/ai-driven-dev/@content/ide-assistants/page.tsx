...
import IDEAssistantsContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('ide-assistants')!;
...
export default function IDEAssistantsPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <IDEAssistantsContent />
    </>
  );
}
