...
import SaaSFromScratchContent from './content';

import JsonLd from '@/components/JsonLd';

const pageData = getAIDrivenDevPageById('saas-from-scratch')!;
...
export default function SaaSFromScratchPage() {
  return (
    <>
      <JsonLd data={structuredData} />
      <SaaSFromScratchContent />
    </>
  );
}
