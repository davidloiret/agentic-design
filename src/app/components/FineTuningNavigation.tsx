...
const categories: NavigationCategory[] = [
  {
    ...
    icon: '🚀',
    sections: sections.filter(s => s.category === 'getting-started')
  },
  {
    id: 'methods',
    name: 'Methods & Techniques',
    icon: '⚙️',
    sections: sections.filter(s => s.category === 'methods')
  },
  {
    id: 'implementation',
    name: 'Implementation',
    icon: '🔧',
    sections: sections.filter(s => s.category === 'implementation')
  },
  {
    id: 'deployment',
    name: 'Deployment',
      ...
      <div key={category.id} className="space-y-1">
        <div className="w-full rounded-lg lg:rounded-xl transition-all duration-200 text-left group p-1.5 lg:p-2 bg-gray-800/60 hover:bg-gray-800/80 min-h-[36px] lg:min-h-auto">
          <div className="flex items-center gap-1 lg:gap-1">
            ...
            <div className="flex-1 flex items-center gap-1.5 lg:gap-3 cursor-pointer hover:scale-[0.99] transition-transform min-h-[28px] lg:min-h-[32px]">
