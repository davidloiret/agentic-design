        ...
        <div className="markdown-content">
          <ReactMarkdown
            ...
            components={{
              ...
              ol: ({children}) => <ol className="list-decimal list-inside space-y-2 mb-4 text-gray-300 ml-4">{children}</ol>,
              ...
              pre: ({children}) => <pre className="bg-gray-900 rounded-lg p-4 overflow-x-auto mb-4">{children}</pre>,
              blockquote: ({children}) => (
                <blockquote className="border-l-4 border-blue-500 pl-4 text-gray-400 italic mb-4">{children}</blockquote>
              ),
              table: ({children}) => (
              ...
              td: ({children}) => (
                <td className="px-4 py-3 text-sm text-gray-300 whitespace-normal">{children}</td>
              ),
