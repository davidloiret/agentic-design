...
export const LearningHub: React.FC<LearningHubProps> = ({ techniques = [], categories = [] }) => {
  const [userProgress, setUserProgress] = useState<UserProgress>({
    ...
    completedChallenges: [],
    achievements: [],
    currentModule: 'reasoning-techniques'
  });
      ...
      challenges: [
        {
          ...
          xpReward: 40,
          timeEstimate: 20,
          completed: userProgress.completedChallenges.includes('reasoning-flashcards')
        },
        {
          id: 'reasoning-quiz',
          type: 'quiz',
          ...
          xpReward: 60,
          timeEstimate: 25,
          completed: userProgress.completedChallenges.includes('reasoning-quiz')
        },
        {
          id: 'implement-tot',
          type: 'code',
          ...
          xpReward: 100,
          timeEstimate: 60,
          completed: userProgress.completedChallenges.includes('implement-tot')
        }
      ]
    },
    {
      ...
      challenges: [
        {
          ...
          xpReward: 35,
          timeEstimate: 18,
          completed: userProgress.completedChallenges.includes('chaining-flashcards')
        },
        {
          id: 'chaining-quiz',
          type: 'quiz',
          ...
          xpReward: 50,
          timeEstimate: 22,
          completed: userProgress.completedChallenges.includes('chaining-quiz')
        }
      ]
    },
    {
      ...
      challenges: [
        {
          ...
          xpReward: 40,
          timeEstimate: 20,
          completed: userProgress.completedChallenges.includes('routing-flashcards')
        },
        {
          id: 'routing-quiz',
          type: 'quiz',
          ...
          xpReward: 55,
          timeEstimate: 25,
          completed: userProgress.completedChallenges.includes('routing-quiz')
        },
        {
          ...
          xpReward: 120,
          timeEstimate: 75,
          completed: userProgress.completedChallenges.includes('build-dynamic-router')
        }
      ]
    },
    {
      ...
      challenges: [
        {
          ...
          xpReward: 45,
          timeEstimate: 22,
          completed: userProgress.completedChallenges.includes('tool-use-flashcards')
        },
        {
          id: 'tool-use-quiz',
          type: 'quiz',
          ...
          xpReward: 65,
          timeEstimate: 28,
          completed: userProgress.completedChallenges.includes('tool-use-quiz')
        },
        {
          ...
          xpReward: 140,
          timeEstimate: 90,
          completed: userProgress.completedChallenges.includes('build-react-agent')
        }
      ]
    },
    {
      ...
      challenges: [
        {
          ...
          xpReward: 50,
          timeEstimate: 25,
          completed: userProgress.completedChallenges.includes('orchestration-flashcards')
        },
        {
          ...
          xpReward: 75,
          timeEstimate: 35,
          completed: userProgress.completedChallenges.includes('orchestration-quiz')
        }
      ]
    },
    {
      ...
      challenges: [
        {
          ...
          xpReward: 55,
          timeEstimate: 28,
          completed: userProgress.completedChallenges.includes('planning-flashcards')
        },
        {
          id: 'planning-quiz',
          type: 'quiz',
          ...
          xpReward: 80,
          timeEstimate: 40,
          completed: userProgress.completedChallenges.includes('planning-quiz')
        }
      ]
    },
    {
      ...
      challenges: [
        {
          ...
          xpReward: 100,
          timeEstimate: 45,
          completed: userProgress.completedChallenges.includes('advanced-pattern-selection')
        },
        {
          ...
          xpReward: 200,
          timeEstimate: 120,
          completed: userProgress.completedChallenges.includes('system-architecture')
        }
      ]
    }
  ];
  ...
  const getCurrentLevel = () => {
    return LEVELS.reduce((prev, current) => 
      userProgress.xp >= current.xpRequired ? current : prev
    );
  };

  const getNextLevel = () => {
    return LEVELS.find(level => level.xpRequired > userProgress.xp) || LEVELS[LEVELS.length - 1];
  };
  ...
  const getProgressToNextLevel = () => {
    ...
    const progress = ((userProgress.xp - currentLevel.xpRequired) / (nextLevel.xpRequired - currentLevel.xpRequired)) * 100;
  ...
  const handleChallengeComplete = (challengeId: string, score: number, xpEarned: number) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-yellow-400">200 XP required</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Tool Use & Integration</span>
                    <span className="text-yellow-400">350 XP required</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Workflow Orchestration</span>
                    <span className="text-red-400">600 XP required</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Planning & Execution</span>
                    <span className="text-red-400">900 XP required</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Pattern Selection Mastery</span>
                    <span className="text-purple-400">1200 XP required</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-green-500/10 rounded-xl p-6 border border-green-500/20">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  You need <strong>{200 - userProgress.xp} more XP</strong> to unlock the Intelligent Routing module. Here's the fastest path:
                </p>
        ...
        <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
          ...
          {userProgress.completedChallenges.length > 0 ? (
            <div className="space-y-3">
              {userProgress.completedChallenges.slice(-3).map((challengeId, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 bg-gray-700/30 rounded-lg">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-gray-300 text-sm">Completed challenge: {challengeId}</span>
                </div>
              ))}
            </div>
          ) : (
        ...
        {module.isLocked && (
          <div className="mb-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
            ...
            <div className="text-sm text-gray-300">
              ...
              <div className="flex items-center justify-between">
                <span>Your XP:</span>
                <span className={userProgress.xp >= unlockRequirement ? 'text-green-400' : 'text-red-400'}>
                  {userProgress.xp} XP
                </span>
              </div>
              <div className="flex items-center justify-between mt-1">
                ...
                <span className="font-medium text-yellow-400">
                  {Math.max(0, unlockRequirement - userProgress.xp)} XP
                </span>
              </div>
            </div>
            {userProgress.xp >= unlockRequirement && (
    ...
    <div className="max-w-7xl mx-auto">
      ...
      {activeView === 'learning' && !selectedModule && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-400">
              {userProgress.xp} XP • Level {getCurrentLevel().level}
            </div>
          </div>
      ...
      {activeView === 'certification' && (
        <div className="text-center py-20">
          ...
          <p className="text-gray-400">Complete all modules to unlock certification!</p>
        </div>
      )}
    </div>
  );
